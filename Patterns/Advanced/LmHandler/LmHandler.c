...
#include "lorawan_conf.h" /* needed for LORAMAC_CLASSB_ENABLED */
...
LmHandlerErrorStatus_t LmHandlerConfigure( LmHandlerParams_t *handlerParams )
{
  ...
  else
  {
...
#if ( HYBRID_ENABLED == 1 )
    if ((LmHandlerParams.ActiveRegion == LORAMAC_REGION_AU915) || (LmHandlerParams.ActiveRegion == LORAMAC_REGION_US915))
    {
    ...
    else if (LmHandlerParams.ActiveRegion == LORAMAC_REGION_CN470) 
    {
